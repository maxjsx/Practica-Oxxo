...
print("🚀 Iniciando FTE ESTABLE (Alineación CECO + PQ Match)...")
...
# FIX DE ALINEACIÓN: Aseguramos que el CECO sea puro texto en la matriz original
...
# LA CLAVE: Conservamos el Identificador en formato crudo para cruzar igual que PQ
...
# Permisos: Se excluyen Vacaciones
...
# FIX DE LOS 16.12 PUNTOS: Simulamos la lógica a ciegas de "Table.Distinct" de Power Query.
# En lugar de ordenar por mayor cantidad de días, simplemente tomamos la PRIMERA coincidencia.
...
# FIX DE ALINEACIÓN: Obligamos a que CECO_1 sea puramente de tipo STRING
...
# Mapeamos usando Identificador Crudo (Simula PQ)
