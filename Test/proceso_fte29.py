...
print("🚀 Iniciando FTE V-FINAL (Alineación Perfecta de CECOs)...")
...
# FIX 1: Forzar CECO a ser texto SIEMPRE para evitar el desorden numérico/alfabético
...
df_incl = df_incl.drop_duplicates("RUT_TALANA")
dict_fte_incl = dict(zip(df_incl["RUT_TALANA"], df_incl["FTE INCLS"].apply(to_float_safe)))
...
# ==========================================
# 6. RESUMEN EJECUTIVO (EL FIX DE ALINEACIÓN)
# ==========================================
print("Generando Tablas Dinámicas y Brechas...")

# Agrupamos la asistencia
...
# FIX 2: Tomar TODAS las tiendas del Autorizado como base para no saltarse ninguna
...
# Cruzamos la Asistencia hacia el Autorizado
resumen = pd.merge(resumen, agg_df, on="CECO", how="left")

# Las tiendas vacías se rellenan con 0
...
# Aseguramos el orden alfanumérico estricto
