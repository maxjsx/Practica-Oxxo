...
print("🚀 Iniciando FTE V20.1 (Fix de Columnas Duplicadas - ABRIL 2026)...")
...
# ==========================================
# 3. CARGA DE AGRUPADOR (EL FIX DEL DOBLE SALTO)
# ==========================================
print("Cargando Agrupador (Doble Salto Exacto)...")
df_agr = pd.read_excel("Agrupador 10.xlsx", sheet_name="AGRUPADOR", header=4)

# FIX: Hay dos columnas "Agrupador". Extraemos directamente por índice para no equivocarnos.
# Índice 14 = CARGO, Índice 15 = AGRUPADOR (El real), Índice 18 = FTE TEORICO2
...
# Sobrescribimos el dict de bajas (SAP Inactivos + Reporte Bajas)
...
# Si hay múltiples permisos, Power Query expande (LeftJoin). Para simularlo y calcular el "Dias 2" máximo,
# agruparemos tomando el máximo de días que aplique al mes (o PQ toma la primera coincidencia con un drop_duplicates)
df_perm_unique = df_perm.drop_duplicates(subset=["RUT_TALANA"])
