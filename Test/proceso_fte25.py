...
print("🚀 Iniciando FTE V21.0 (Versión Definitiva ABRIL 2026)...")
...
# Índices directos para evitar confusión con columnas duplicadas en el Excel
...
# Dict 2: Agrupador Real -> FTE Teorico (simulando Left Join de PQ)
...
# --- PERMISOS CON PROTECCIÓN DE VACACIONES ---
...
# FIX DEFINITIVO: Descartar las "Vacaciones" para que no se sumen a la regla de los >15 días
...
def calcular_fte_real(row):
    if row["Dias 2"] > 15:
        ...
        # Prioriza Agrupador para el FTE (Ignora decimales intermedios de Inclusiones)
