...
# ==========================================
# ACTUALIZACIÓN: Fecha de corte (Asumiremos fin de mes o el día en que extraes la data de Abril)
# Si necesitas una fecha específica de abril, cámbiala aquí.
...
print("🚀 Iniciando FTE V18.0 (Actualización ABRIL 2026)...")

# ==========================================
# 2. CARGA DE MAESTRA DE TIENDAS (AUTORIZADO)
# ==========================================
print("Cargando matriz de tiendas (Abril)...")
# ACTUALIZACIÓN: Cambio a la hoja de Abril
...
# ACTUALIZACIÓN: La columna ahora se llama FTE TEORICO2
...
ruts_licencia_larga = set(df_perm[
    (df_perm["Tipo Permiso"].str.contains('Licencia|Post Natal|Accidente|Cuidado', case=False, na=False)) & 
    (df_perm["DURACION"] > 15) & 
...
# ==========================================
print("Aplicando regla de cargos y FTE...")
...
try:
    ...
    print(f"\n✅ REPORTE CREADO CON ÉXITO PARA ABRIL 2026.\nEl archivo está en:\n{ruta}")
