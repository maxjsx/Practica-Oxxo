...
print("🚀 Iniciando FTE V17.1 (Parche Brechas LIDER DE TIENDA)...")
...
# --- CORRECCIÓN DEL DICCIONARIO DE BRECHAS ---
# Formato: "Nombre Columna Autorizado": ("Nombre Exacto en Agrupador", "Nombre Limpio Visual")
map_cols_brecha = {
